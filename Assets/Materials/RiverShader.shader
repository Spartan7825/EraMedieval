Shader "Custom/RiverShader" {
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            float2 specCoordinates1 = IN.uv_Specs1 + _SpecDirection1 * _Time.y * _Speed;
            ...
            float2 specCoordinates2 = IN.uv_Specs2 + _SpecDirection2 * _Time.y * _Speed;
            ...
            //add foam
            float2 foamCoords = IN.uv_FoamNoise + _FoamDirection * _Time.y * _Speed;
